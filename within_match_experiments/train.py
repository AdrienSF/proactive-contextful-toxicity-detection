...
from custom.datasets import (
    ...
    current_player_only_special_tokens,
    int_label,
    team_player_tokens,
    msep_token
)
...
hyperparams = [
    # ['distilbert/distilroberta-base', point_seperate_messages, [], 7e-6],# could try 7e-6
    ...
    ['../models/mlm/distilroberta-base_player_tokens_blob_input-2024-05-17_17-55-51/checkpoint-276950', add_special_tokens, team_player_tokens, 1e-5],
    # ['../models/mlm/distilroberta-base_player_tokens_blob_input-2024-05-17_17-55-51/checkpoint-276950', current_player_only_special_tokens, team_player_tokens, 4e-6],
]
